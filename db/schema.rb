...
<<<<<<< HEAD
ActiveRecord::Schema.define(version: 2020_09_29_094102) do

=======
ActiveRecord::Schema.define(version: 2020_09_22_204558) do
>>>>>>> 7a98cb344d425d6fb1d5e1938b00a4dd4482d17e
  ...
  create_table "team_documents", force: :cascade do |t|
    t.bigint "team_id", null: false
    t.bigint "document_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["document_id"], name: "index_team_documents_on_document_id"
    t.index ["team_id"], name: "index_team_documents_on_team_id"
  end
  ...
  add_foreign_key "team_documents", "documents"
